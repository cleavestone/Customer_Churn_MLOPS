...
- ☁️ **AWS-ready deployment** (via ECR & ECS Fargate)
...
| Deployment Target   | AWS ECR + ECS Fargate |
| Monitoring          | Grafana |
...
- ✅ CI pipeline implemented (builds Docker image & pushes to AWS ECR)
- 🔄 CD pipeline in progress (ECS Fargate deployment)
